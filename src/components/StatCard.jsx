...
const StatCard = ({ label, value, icon: Icon, labelColor = "text-gray-600" }) => {
  return (
    <Link to={`/${label.toLowerCase()}`}>
      <div className="flex-1 min-w-[140px] bg-secondary dark:bg-secondary text-foreground dark:text-foreground rounded-2xl shadow-md px-4 py-6 text-center hover:shadow-lg transition border dark:border-accent">
        {Icon && (
